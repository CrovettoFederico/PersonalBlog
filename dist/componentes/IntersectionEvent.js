...
/***/ "./src/componentes/IntersectionEvent.tsx":
/*!***********************************************!*\
  !*** ./src/componentes/IntersectionEvent.tsx ***!
  \***********************************************/
...
exports.IntersectionEvent = void 0;
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var IntersectionEvent = /** @class */ (function (_super) {
    __extends(IntersectionEvent, _super);
    function IntersectionEvent(props) {
        var _a;
        ...
        _this.state = {
            ...
            repeat: props.repeat,
            Children: (_a = props.Children) !== null && _a !== void 0 ? _a : []
        };
        _this.target = null;
        return _this;
    }
    IntersectionEvent.prototype.componentDidMount = function () {
        var _this = this;
        ...
        var FooterObserver = new IntersectionObserver(function (entries, observer) {
            entries.forEach(function (entry) {
                ...
                if (!_this.state.repeat)
                    observer.unobserve(_this.target);
            });
        });
        FooterObserver.observe(this.target);
    };
    IntersectionEvent.prototype.render = function () {
        var _a;
        return (React.createElement("div", { id: this.state.TargetId }, (_a = this.state.Children) === null || _a === void 0 ? void 0 : _a.map(function (element, index) { return (element); })));
    };
    return IntersectionEvent;
}(React.Component));
exports.IntersectionEvent = IntersectionEvent;
